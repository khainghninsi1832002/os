...
<head>
  ...
  <link href="{{asset('backend1/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('brands.index')}}" aria-expanded="true" aria-controls="collapsePages">
  ...
  <script src="{{asset('backend1/js/sb-admin-2.min.js')}}"></script>

  <!-- Page level plugins -->
  <script src="{{asset('backend1/vendor/chart.js/Chart.min.js')}}"></script>

  <!-- Page level custom scripts -->
  <script src="{{asset('backend1/js/demo/chart-area-demo.js')}}"></script>
  <script src="{{asset('backend1/js/demo/chart-pie-demo.js')}}"></script>
  @yield('script')
